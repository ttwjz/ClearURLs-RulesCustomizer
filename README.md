...
[![Rules Updated](https://img.shields.io/endpoint?url=https://ttwjz.github.io/ClearURLs-RulesCustomizer/badge.json)](https://github.com/ttwjz/ClearURLs-RulesCustomizer/commits/main)
...
*   **智能合并**：
    ...
    *   自动处理正则表达式的转义问题（区分手写原生正则与复制转义正则）。
...
4.  将 **Source** 设置为 `Deploy from a branch`，分支选择 `gh-pages`，文件夹选择 `/ (root)`。
...
*   **规则逻辑**：基于 [Kevin Roebert](https://gitlab.com/KevinRoebert) 的 [ClearURLs](https://gitlab.com/ClearURLs/ClearURLs) 项目。
