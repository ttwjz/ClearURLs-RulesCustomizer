...
> 🌏 **特别说明**：本仓库默认维护了一份**适用于中国🇨🇳用户的增强规则**，针对 **Baidu (百度)**、**Bing CN (必应中国)** 等国内常用网站进行了深度的参数清理优化。
...
*   **自动同步**：每天定时拉取 GitLab 上游最新规则，确保基准规则不过时。
...
*   **上游规则**：[ClearURLs Data](https://gitlab.com/KevinRoebert/ClearURLs/-/tree/master/data)。
